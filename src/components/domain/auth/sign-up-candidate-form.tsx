  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4" noValidate>
      ...
      <Controller
        ...
        name="consent"
        render={({ field }) => (
          <div className="border-border bg-mist rounded-[12px] border p-4">
            ...
            <p id="consent-detail" className="text-muted-foreground mt-2 pl-8 text-xs">
            ...
            <div className="pl-8">
              <FieldError error={form.formState.errors.consent?.message} />
            </div>
          </div>
        )}
      />
