...
values
  ('a0000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'admin@example.com', '$2b$10$pes8d.KT0F.Ua..27SzpNO6Iog6yX/0IWpfe0gs3dkmYVLAktrFWq', now(), '{"provider":"email","providers":["email"]}', '{"role":"candidate","full_name":"Dexee Admin","locale":"en"}', '', '', '', '', now(), now()),
